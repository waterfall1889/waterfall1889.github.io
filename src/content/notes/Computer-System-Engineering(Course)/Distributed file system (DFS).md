...
<img title="" src="../images/Computer-System-Engineering(Course)/Distributed file system (DFS)/FTP.png" alt="" width="752">
...
<img src="../images/Computer-System-Engineering(Course)/Distributed file system (DFS)/2026-08-22-13-49-15-image.png" alt="" width="777">
...
<img src="../images/Computer-System-Engineering(Course)/Distributed file system (DFS)/2026-08-22-14-56-37-image.png" alt="" width="422">
...
<img src="../images/Computer-System-Engineering(Course)/Distributed file system (DFS)/2026-08-22-15-43-44-image.png" alt="" width="549">

一台机器作为master，然后还有若干台chunk server。chunk的大小大于普通的文件系统，因为GFS往往用于大型文件系统。Master用于负责告知Client需要的数据在哪里，本身不会直接传输数据给client。

<img src="../images/Computer-System-Engineering(Course)/Distributed file system (DFS)/2026-08-22-16-01-36-image.png" alt="" width="494">
...
<img src="../images/Computer-System-Engineering(Course)/Distributed file system (DFS)/2026-08-22-16-45-09-image.png" alt="" width="756">
...
<img src="../images/Computer-System-Engineering(Course)/Distributed file system (DFS)/2026-08-22-16-46-52-image.png" alt="" width="757">

- 此时所有副本（A、B、C）的内存中都已经缓存了这批数据，但尚未写入磁盘。

- 当确认所有的chunkserver均确认数据全部接收到对应数据包（ACK）后，client发送正式的**写入请求**给主副本所在的chunkserver

<img src="../images/Computer-System-Engineering(Course)/Distributed file system (DFS)/2026-08-22-16-48-26-image.png" alt="" width="752">
...
<img src="../images/Computer-System-Engineering(Course)/Distributed file system (DFS)/2026-08-22-16-49-54-image.png" alt="" width="761">

- **所有其他次要副本chunkserver需要给主副本chunkserver回复“写入成功”，然后主副本chunkserver才能告知client已经写入成功（ACK）**

<img src="../images/Computer-System-Engineering(Course)/Distributed file system (DFS)/2026-08-22-16-50-44-image.png" alt="" width="758">

<img src="../images/Computer-System-Engineering(Course)/Distributed file system (DFS)/2026-08-22-16-51-18-image.png" alt="" width="759">
